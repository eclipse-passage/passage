...
public class LicensePlanField extends TextField<LicensePlanDescriptor> {

	protected LicensePlanField(Optional<LicensePlanDescriptor> plan, Runnable modified, LabelProvider labels,
