...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Evaluation Instructions</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class EvaluationInstructionsImpl extends MinimalEObjectImpl.Container implements EvaluationInstructions {
	...
	protected EClass eStaticClass() {
		return FloatingPackage.eINSTANCE.getEvaluationInstructions();
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, FloatingPackage.EVALUATION_INSTRUCTIONS__TYPE,
					oldType, type));
		}
	}
	...
	public void setExpression(String newExpression) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, FloatingPackage.EVALUATION_INSTRUCTIONS__EXPRESSION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case FloatingPackage.EVALUATION_INSTRUCTIONS__TYPE:
			return getType();
		case FloatingPackage.EVALUATION_INSTRUCTIONS__EXPRESSION:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case FloatingPackage.EVALUATION_INSTRUCTIONS__TYPE:
			return !Objects.equals(TYPE_EDEFAULT, type);
		case FloatingPackage.EVALUATION_INSTRUCTIONS__EXPRESSION:
			return !Objects.equals(EXPRESSION_EDEFAULT, expression);
		default:
