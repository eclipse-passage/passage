 ...
 * <p>
 * In a sentence, AM serves the only purpose. It can be asked,
 * if it is allowed to use a particular feature <o>now</o>,
 * and the answer will be simple <i>yes</i> or </i>no</i> of different colours.
 * </p>
 * <p>
 * Access manager:
 ...
 * - examin is these permissions are enough to satisfy all the requirments.
 ...
 * <h1>Access management</h1>
 * <p>
 * In a sentence, AM serves the only purpose. A program under licence protection, been run, can ask AM,
 ...
 * These are given by the program under licence protection.</li>
 * <li></li>
 * <li></li>
 * <li></li>
 * </ul>
 ...
 * <ul>
 * <li>AM uses<i>Requirement</i>s to define at runtime, which feature can be used under which circumstances.
 * These are given by the installation of the program under licence protection.</li>
 * <li></li>
 * <li></li>
 * <li></li>
 * </ul>
 ...
 * In a paragraph,
 * <ul>
 * <li>A program, been run, is asked by it's user to access a particular feature. Which has been implemented as a <i>feature under licence protection</i></li>
 * <li>AM uses <i>Requirement</i>s to define at runtime, which feature can be used under which circumstances.
 * These are given by the installation of the program under licence protection.</li>
 *
 * <li></li>
 ...
 * In a paragraph:
 * <ul>
 * <li>A program, been run, is asked by it's user to access a particular feature.
 * Which has been implemented as a <i>feature under licence protection</i></li>
 * <li>Here Passage invokes AM to define, can the user exploit the feature or not.</li>
 * <li>AM uses <i>Requirement</i>s to define at runtime, which feature can be used under which circumstances.
 * These are given by the installation of the program under licence protection.
 ...
 * The result of this step is a set of {@link org.eclipse.passage.lic.api.requirements.LicensingRequirement}s</li>
 * <li>Then AM needs to find out, what the licence that the user acquired, allows to do. </li>
 *
 * <li></li>
 * <li></li>
 * <li></li>
 ...
 * So the first thing AM does is finding out, is the actual program installation possesses any
 * <i>protect this feature</i> instructions in the first place.
 * To do this, AM appeals to  {@link org.eclipse.passage.lic.api.requirements.RequirementResolver} and gets
 ...
 * AM goes to {@link org.eclipse.passage.lic.api.conditions.ConditionMiner}
 * and gets set of {@link org.eclipse.passage.lic.api.conditions.LicensingCondition }.
 * </li>
 *
 * <li></li>
 * <li></li>
 ...
 * {@link org.eclipse.passage.lic.api.conditions.ConditionMiner} looks for them in <b>the licence</b>,
 * on a floating server or mining another type of source.
 * </li>
 *
 * <li></li>
 * <li></li>
