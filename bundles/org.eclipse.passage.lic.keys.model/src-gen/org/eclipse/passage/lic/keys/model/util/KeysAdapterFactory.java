...
public class KeysAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected KeysSwitch<Adapter> modelSwitch = new KeysSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.passage.lic.keys.model.api.KeyPair <em>Key Pair</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.passage.lic.keys.model.api.ProductRef <em>Product Ref</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
