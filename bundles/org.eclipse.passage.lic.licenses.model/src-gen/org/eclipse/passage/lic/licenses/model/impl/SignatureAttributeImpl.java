 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.passage.lic.licenses.model.impl.SignatureAttributeImpl#getName <em>Name</em>}</li>
...
public class SignatureAttributeImpl extends MinimalEObjectImpl.Container implements SignatureAttribute {
	 ...
	 * @ordered
	 */
	private String value = VALUE_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return LicensesPackage.eINSTANCE.getSignatureAttribute();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, LicensesPackage.SIGNATURE_ATTRIBUTE__NAME, oldName,
					name));
		}
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, LicensesPackage.SIGNATURE_ATTRIBUTE__VALUE, oldValue,
					value));
		}
	}
