 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.passage.lic.licenses.model.impl.EvaluationInstructionsImpl#getType <em>Type</em>}</li>
...
public class EvaluationInstructionsImpl extends MinimalEObjectImpl.Container implements EvaluationInstructions {
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, LicensesPackage.EVALUATION_INSTRUCTIONS__TYPE,
					oldType, type));
		}
	}
	...
	public void setExpression(String newExpression) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, LicensesPackage.EVALUATION_INSTRUCTIONS__EXPRESSION,
