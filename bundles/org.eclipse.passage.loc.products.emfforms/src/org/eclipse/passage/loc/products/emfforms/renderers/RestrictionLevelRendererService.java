...
@Component
public class RestrictionLevelRendererService extends StructuredFeatureRendererService
		implements EMFFormsDIRendererService<VControl> {

	public RestrictionLevelRendererService() {
		super(RestrictionLevelRenderer.class, ProductsPackage.eINSTANCE.getProductVersionFeature_RestrictionLevel());
	}
