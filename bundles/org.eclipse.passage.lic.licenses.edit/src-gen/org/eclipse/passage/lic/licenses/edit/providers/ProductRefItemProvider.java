...
/**
 * This is the item provider adapter for a {@link org.eclipse.passage.lic.licenses.model.api.ProductRef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @since 2.0
 * @generated
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ProductRef_version_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ProductRef_type"), //$NON-NLS-1$
						LicensesPackage.eINSTANCE.getProductRef_Version(), true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
