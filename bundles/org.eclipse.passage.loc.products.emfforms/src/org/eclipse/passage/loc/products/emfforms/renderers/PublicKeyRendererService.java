...
@Component
public class PublicKeyRendererService extends StructuredFeatureRendererService
		implements EMFFormsDIRendererService<VControl> {

	public PublicKeyRendererService() {
		super(PublicKeyRenderer.class, ProductsPackage.eINSTANCE.getProductVersion_InstallationToken());
	}
