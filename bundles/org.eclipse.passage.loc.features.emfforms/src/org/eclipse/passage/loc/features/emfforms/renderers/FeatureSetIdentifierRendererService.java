...
@Component
public class FeatureSetIdentifierRendererService extends StructuredFeatureRendererService
		implements EMFFormsDIRendererService<VControl> {

	public FeatureSetIdentifierRendererService() {
		super(ValidatedTextRenderer.class, FeaturesPackage.eINSTANCE.getFeatureSet_Identifier());
	}
