 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.passage.lic.licenses.model.impl.UserRefImpl#getIdentifier <em>Identifier</em>}</li>
...
public class UserRefImpl extends MinimalEObjectImpl.Container implements UserRef {
	...
	protected EClass eStaticClass() {
		return LicensesPackage.eINSTANCE.getUserRef();
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, LicensesPackage.USER_REF__IDENTIFIER, oldIdentifier,
					identifier));
		}
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, LicensesPackage.USER_REF__NAME, oldName, name));
		}
	}
