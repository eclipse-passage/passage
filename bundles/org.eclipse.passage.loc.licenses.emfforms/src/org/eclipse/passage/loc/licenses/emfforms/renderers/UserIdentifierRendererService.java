...
@Component
public class UserIdentifierRendererService extends StructuredFeatureRendererService
		implements EMFFormsDIRendererService<VControl> {

	public UserIdentifierRendererService() {
		super(UserIdentifierRenderer.class, LicensesPackage.eINSTANCE.getLicensePack_UserIdentifier());
	}
