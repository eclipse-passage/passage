...
public class ValidityPeriodClosedImpl extends MinimalEObjectImpl.Container implements ValidityPeriodClosed {
	...
	protected EClass eStaticClass() {
		return FloatingPackage.eINSTANCE.getValidityPeriodClosed();
	}
	...
	public void setFrom(Date newFrom) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, FloatingPackage.VALIDITY_PERIOD_CLOSED__FROM, oldFrom,
					from));
		}
	}
	...
	public void setUntil(Date newUntil) {
		...
		until = newUntil;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, FloatingPackage.VALIDITY_PERIOD_CLOSED__UNTIL,
					oldUntil, until));
		}
	}
