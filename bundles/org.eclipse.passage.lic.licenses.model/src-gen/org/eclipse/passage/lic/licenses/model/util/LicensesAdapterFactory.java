...
public class LicensesAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * Pack Descriptor</em>}'. <!-- begin-user-doc --> This default implementation
	 ...
	 * Grant Descriptor</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	 ...
	 * Pack</em>}'. <!-- begin-user-doc --> This default implementation returns null
