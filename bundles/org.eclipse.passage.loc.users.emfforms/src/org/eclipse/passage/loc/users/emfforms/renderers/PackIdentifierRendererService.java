...
@Component
public class PackIdentifierRendererService extends StructuredFeatureRendererService
		implements EMFFormsDIRendererService<VControl> {

	public PackIdentifierRendererService() {
		super(PackIdentifierRenderer.class, UsersPackage.eINSTANCE.getUserLicense_PackIdentifier());
	}
