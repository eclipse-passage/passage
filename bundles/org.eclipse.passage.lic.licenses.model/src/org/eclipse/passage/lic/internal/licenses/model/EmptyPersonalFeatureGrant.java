...
public final class EmptyPersonalFeatureGrant implements Supplier<PersonalFeatureGrant> {
	...
	public PersonalFeatureGrant get() {
		PersonalFeatureGrant grant = LicensesFactory.eINSTANCE.createPersonalFeatureGrant();
		...
		grant.setUserAuthentication(LicensesFactory.eINSTANCE.createEvaluationInstructions());
		grant.setValid(LicensesFactory.eINSTANCE.createValidityPeriodClosed());
		return grant;
	}
