...
public class FloatingAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * <em>License Pack</em>}'. <!-- begin-user-doc --> This default implementation
	 ...
	 * <em>License Requisites</em>}'. <!-- begin-user-doc --> This default
	 ...
	 * Grant</em>}'. <!-- begin-user-doc --> This default implementation returns
	 ...
	 * <em>Validity Period</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.eclipse.passage.lic.floating.model.api.ValidityPeriodClosed
	 * <em>Validity Period Closed</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.eclipse.passage.lic.floating.model.api.EvaluationInstructions
	 * <em>Evaluation Instructions</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	 ...
	 * Match</em>}'. <!-- begin-user-doc --> This default implementation returns
	 * null so that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
